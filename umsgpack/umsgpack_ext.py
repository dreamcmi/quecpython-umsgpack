...
# Options (kwargs to dump and dumps) may be passed to conustructor including new
...
class Complex:
    ...
    def packb(self):
        return ustruct.pack(">ff", self.c.real, self.c.imag)

    @staticmethod
    def unpackb(data):
        return complex(*ustruct.unpack(">ff", data))
